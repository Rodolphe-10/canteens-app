...
export default function Footer({ locale }: { locale: string }) {
  return (
    <footer className="bg-tc-dark border-t border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
          {/* Logo & tagline */}
          <div className="flex flex-col gap-3">
            <span className="font-serif text-2xl font-bold text-gradient-gold tracking-widest">
              THE CANTEEN&apos;S
            </span>
            <span className="text-xs text-tc-cream/40 tracking-widest uppercase">
              Restaurant · Bar · Lounge · Game Room
            </span>
            <p className="text-sm text-tc-cream/50 italic mt-2">
